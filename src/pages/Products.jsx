...
const Products = () => {
    ...
    const handlePrimaryImageLink = (e) => {
        console.log(e.target.files[0])
        console.log(watch('name'))

        UploadPicture(e.target.files[0], `${watch('name')} primary image`)
        // .then(async (res) => {
        //     console.log(res)
        //     if (res.data.success) {
    ...
    const onSubmit = async(data) => {
        console.log(data);
        const primaryImageLink = await UploadPicture(data?.primaryImage[0], `${data?.name} primary image`)
        const secoundImageLink = await UploadPicture(data?.SecondImage[0], `${data?.name} primary image`)
        const thirdImageLink = await UploadPicture(data?.ThirdImage[0], `${data?.name} primary image`)
        const forthImageLink = await UploadPicture(data?.FourthImage[0], `${data?.name} primary image`)
        console.log(primaryImageLink)
    }
            ...
            <div className="max-w-4xl p-6  rounded-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-wrap justify-between">
                    ...
                    <div className="w-full  mb-4">
                        <label htmlFor="additionalInfo" className="block text-gray-800 font-semibold mb-2">
                            Additional Info
                        </label>
                        <textarea
                            id="additionalInfo"
                    ...
                    <div className="w-full  mb-4">
                        ...
                        <input
                            type="file"
                            id="primaryImage"
                            onChange={handlePrimaryImageLink}
                    ...
                    <div className="w-full mb-4">
                        <label htmlFor="SecondImage" className="block text-gray-800 font-semibold mb-2">
                            Second Image
                        </label>
                        <input
                            type="file"
                    ...
                    <div className="w-full  mb-4">
                        <label htmlFor="ThirdImage" className="block text-gray-800 font-semibold mb-2">
                            Third Image
                        </label>
                        <input
                            type="file"
                    ...
                    <div className="w-full  mb-4">
                        <label htmlFor="FourthImage" className="block text-gray-800 font-semibold mb-2">
                            Fouth Image
                        </label>
                        <input
                            type="file"
                    ...
                    <div className="w-full md:w-1/2 mb-4">
                        <label htmlFor="quantity" className="block text-gray-800 font-semibold mb-2">
                            Product Quantity
                        </label>
                        <input
                            type="number"
                    ...
                    <div className="w-full mb-4 flex items-center">
                        ...
                        />
                        <label htmlFor="newArrival" className="text-gray-800 font-semibold">
                            New Arrival Product
                        </label>
                    </div>
                    <button
